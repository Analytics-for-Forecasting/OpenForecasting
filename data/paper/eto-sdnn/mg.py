...
class esn(esn_base):
    ...
    def hyper_modify(self):
        ...
        self.hyper.weight_scaling = 0.8
        self.hyper.hidden_size = 1000
...
class gesn(esn_base):
    ...
    def hyper_modify(self):
        ...
        self.hyper.branch_size = 200
        self.hyper.weight_scaling = 0.9483
        self.hyper.iw_bound = (-0.1,0.1)
        self.hyper.hw_bound = (0.66,0.99)
        self.hyper.nonlinearity = 'sigmoid'
        self.hyper.init = 'svd'
...
#         self.hyper.esn.hyper.hidden_size = 100
#         self.hyper.esn.tuning.hidden_size = tune.qrandint(5, 100, 5)

#         self.hyper.cnn.hyper.kernel_size = 250
